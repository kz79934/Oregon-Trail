...
function getLeaderName() {
    ...
    var t = "<img src='image/family.png' alt='HTML5 Icon' style='display: block; margin-left: 300px; width: 50%;'></img>\
...
function initStore() {
    ...
    var t = "<h3>Krunal's General Store</h3><h4>Independence, Missouri<br>" + months[month] + " 1, 1848</h4>\
            <img src='image/Krunal.png' alt='HTML5 Icon' style='position: fixed; left: 200px; width: 15%;'></img>\
